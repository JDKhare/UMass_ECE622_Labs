...
int main(int argc, char** argv) {
  if (argc != 7) {
    cerr << "Usage: " << argv[0] << " <verilog_file> <target_state_bitstring> <unroll_depth> <init_state_bitstring> <out_dimacs> <out_nodes>\n";
    return 1;
  }
  ...
  string dimacs_path = argv[5];
  string nodes_path = argv[6];
